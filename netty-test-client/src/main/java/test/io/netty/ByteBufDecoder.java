...
public class ByteBufDecoder extends Decoder {
    ...
    public float readFloat() throws IOException {
        final int n = (this.buffer.readUnsignedByte() & 0xff)
                | ((this.buffer.readUnsignedByte() & 0xff) << 8)
                | ((this.buffer.readUnsignedByte() & 0xff) << 16)
                | ((this.buffer.readUnsignedByte() & 0xff) << 24);
        return Float.intBitsToFloat(n);
    }

    @Override
    public double readDouble() throws IOException {
        final long n = (((long) this.buffer.readUnsignedByte()) & 0xff)
                | ((((long) this.buffer.readUnsignedByte()) & 0xff) << 8)
    ...
    @Override
    public void readFixed(final byte[] bytes, final int start, final int length)
            throws IOException {
